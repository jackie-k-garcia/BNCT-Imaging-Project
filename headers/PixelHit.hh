...
class PixelHit : public G4VHit
{
  ...
  public:
    ...
    inline void SetPixelLoc(G4ThreeVector xyz) {pixelLoc = xyz;}
    ...
    inline void SetEngDepPix(G4double de) {engDepPix = de;}

    // Add energy deposition to the pixel.
    inline void AddEngDepPix(G4double de) {engDepPix += de;}

    // Get the energy deposition in the pixel.
    inline G4double GetEngDepPix(G4double dl) {return engDepPix;}
    ...
    inline G4ThreeVector GetSetPos() {return hitPos;}
